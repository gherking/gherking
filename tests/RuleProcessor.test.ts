...
describe("RuleProcessor", ()=> {
    ...
    test("should handle if no pre/post-filter or event handler is set", async () => {
        ...
        const result1 = await ruleProcessor.execute(items1 as Rule[], feature1);
        const result2 = await ruleProcessor.execute(items2 as Rule[], feature2);
    ...
    test("should process array of rules with event handler", async () => {
        ...
        const results = await ruleProcessor.execute(items as Rule[], feature2);
    ...
    test("should process scenarios", async () => {
        ...
        const results = await ruleProcessor.execute(feature1.elements as Rule[], feature1);
