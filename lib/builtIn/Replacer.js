...
class Replacer extends DefaultConfig {
    ...
    /**
     *
     * @param obj The config json
     * @param keys The content of the json (containing the words to replace and the words to replace them with)
     * @private
     */
    ...
    /**
     *
     * @param row A row of an Examples table
     * @private
     */
